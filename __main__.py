...
# loading template via "akamai pm import -p pulumi_template" from akamai control center.
# we added "hostname": "${env.originHostname}" to main.json.
# moved config-snippets to property-snippets as template resource is expecting property-snippets.
# as we added information to our template no need to lookup and assign cpcode
# already part of the template in this case.
template_file = "pulumi_template/property-snippets/main.json"
